	...
	<div class="min-h-screen bg-stone-50 text-stone-950 dark:bg-slate-950 dark:text-white">
		...
		<main class="mx-auto grid max-w-7xl gap-8 px-5 py-6 lg:grid-cols-[1fr_0.9fr]">
			<section>
				...
				<div class="aspect-square overflow-hidden rounded-[2rem] bg-white shadow ring-1 ring-stone-200 dark:bg-slate-800 dark:ring-slate-700">
					<RetryingImage class="h-full w-full object-cover transition-opacity" src={imageUrl(selectedProduct)} alt={selectedProduct.name} />
				</div>
			</section>
